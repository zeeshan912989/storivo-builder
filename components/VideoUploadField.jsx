...
export const VideoUploadField = ({ value, onChange, label = "Video" }) => {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex flex-col gap-2">
        {value && (
          <div className="relative w-full aspect-video rounded-lg overflow-hidden border border-gray-200 bg-black group">
            <video src={value} className="w-full h-full object-cover opacity-80" autoPlay muted loop playsInline />
          ...
          <div className="relative bg-white rounded-3xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.3)] w-full max-w-xl overflow-hidden animate-in fade-in zoom-in slide-in-from-bottom-8 duration-500">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-black text-black tracking-tight">Video Manager</h3>
                  <p className="text-xs font-medium text-gray-500">Upload or select your cinematic assets</p>
                </div>
              </div>
            ...
            <div className="p-8">
              ...
              >
                ...
                <div className="text-center relative z-10">
                  <p className="text-xl font-black text-gray-900 tracking-tight">Drop your video here</p>
                  <p className="text-sm text-gray-500 mt-2 font-medium">MP4, WEBM up to 20MB</p>
                </div>
              ...
              <div className="mt-8">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-[10px] font-black uppercase text-gray-400 tracking-[0.2em]">External Link</span>
                  <div className="h-px flex-1 bg-gray-100" />
                </div>
                  ...
                  <div className="relative flex-1">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                      </svg>
                    </div>
                    <input 
                      type="text" 
            ...
            <div className="p-6 bg-gray-50 flex justify-between items-center">
              <p className="text-[10px] text-gray-400 font-medium max-w-[200px]">
                Videos are stored locally. Large files may slow down the editor.
              </p>
